...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" value="<?= $fetch_profile['name']; ?>" required placeholder="Tên tài khoản" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <input type="submit" value="update now" class="btn" name="Cập nhật">
   </form>
