...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="text" name="name" required placeholder="Tên tài khoản" maxlength="20"  class="box" value="<?= $fetch_profile["name"]; ?>">
      ...
      <input type="password" name="old_pass" placeholder="Mật khẩu cũ" maxlength="20"  class="box" oninput="this.value = this.value.replace(/\s/g, '')">
